...
import synth_head from '../images/projects/synthetify/project_head_synth.png'
...
const Synthetify = () => {
  ...
  <Layout theme={theme} setTheme={toggleTheme}>
    ...
    <ProjectHead 
      theme={theme}
      title={'Branding and Responsive Web App for Synthetify'}
    ...
    <div className='project_sec'>
        ...
        <p>A set of outlined icons were created, that could be used in various places, like presentations, LP and web app. Some icons presenting actual actions or features of the web app, and some standard sm icons.</p>
        <div className='project_img_big'><img src={synth_icons} alt={'Icons created for Synthetify project'}/></div>
        <h4>Other graphics</h4>
        <p>
          <ul>
            <li>For whitepaper and social media, a set of neon-colored isometric illustrations was prepared.
              Whitepaper was filled with a lot of long, technical text, so the illustrations were to <b>make
              the content more enjoyable for the user.</b></li>
            <li>Social media graphic needed rather simple design which resembled the look of an actual web app's dashboard,
              with rounded-cornered tiles, <b>to be more readable at a glance.</b></li>
          </ul>    
        </p>
    ...
    <div className='project_sec project_sec_alt'>
      ...
      <p>Web app is maily targeted for desktop. Below, two main tabs from a web app: Staging tab with token actions (mint, deposit, withdraw) and Account tab, with your account details. The other screen presents modal windows that appear on each action, allowing the user to type in transation details.</p>
         <div className='project_img_big'><img src={synth_app} alt={'desktop web app screens: staging tab and account tab'} /></div>
        <div className='project_img_big'><img src={synth_modals} alt={'modal windows: deposit, send and mint'} /></div>
      <p>However, the app was too illustrative and for production, there was a simplified, cleaned up version prepared.
        The aim was to keep the simple look, but make the colors more gray and the layout more dashboard-like.
        Here's the staging tab in the new design.</p>
      <div className='project_img_big'><img src={synth_redesign} alt={'Web app redesign, gray Staging tab'}/></div>
    </div>
    <div className='project_sec'>
      <h3>Mockups</h3>
      <p>A landing page design on a laptop and whitepaper design including isometric illustrations.</p>
      <div className='project_in'>
    ...
    <div className='project_sec project_sec_alt'>
      <h3>Videos</h3>
      <p>A logo animation that could be used in videos, as a loder or on social media, was also prepared during this process.</p>
